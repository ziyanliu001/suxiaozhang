...
export const SENIORS_CARE = {
  coreBelief: '老人是宝。敬老就是爱国。养儿为老，敬老为国。人人为老，老为人人。',
  tenHaveYous: [
    '只有他人，没有自己。',
    '只有陪伴，没有分析。',
    '只有倾听，没有定义。',
...
export const FAMILY_MOTTO = {
  ...
  studyMethod: '用心学家训，通过研习使家人们发现家训的真实义、掌握家训的核心要义并学会运用家训的方法、提升内化家训的能力，时时体察自己的心念和内心世界，处处检验自己通过学习改变了什么、达到了什么新境界，这就是"为学之方"。这是朱熹教学方法的借鉴——循序渐进、熟读精思、虚心涵泳、切己体察、着紧用力、居敬持志，涵盖了从怎么学习到怎么实践的全过程。'
};
