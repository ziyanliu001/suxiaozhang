...
//
// ⚠️（2026-09-11）本文件是 manageStoreProfile/lib/resolveCaller.js 的第四处
// 镜像（与 getPatriarchDashboard、manageReportApproval 并列）——manageDailyMenu
// 原先只有一个不支持漫游的极简 resolveCaller(OPENID)，本次补齐同一套
// authorizedTenants 巡检漫游能力，让采购清单/备餐预测这类新能力也能被
// platform_admin 审计巡检覆盖，不产生第二套不一致的鉴权逻辑。
'use strict';
